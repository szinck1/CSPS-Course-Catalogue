...
def course_result():
	...
	pass_dict = {
		...
		'offerings_cancelled_overall_LY': queries.offerings_cancelled(LAST_YEAR, '%'),
		'offerings_cancelled_overall_TY': queries.offerings_cancelled(THIS_YEAR, '%'),
		...
		'avg_class_size_overall_LY': queries.avg_class_size(LAST_YEAR, '%'),
		'avg_class_size_overall_TY': queries.avg_class_size(THIS_YEAR, '%'),
		...
		'avg_no_shows_overall_LY': round(queries.avg_no_shows(LAST_YEAR, '%'), 1),
		'avg_no_shows_overall_TY': round(queries.avg_no_shows(THIS_YEAR, '%'), 1),
